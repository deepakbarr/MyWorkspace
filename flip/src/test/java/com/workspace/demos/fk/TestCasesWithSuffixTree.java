 ...
 */
public class TestCasesWithSuffixTree extends TestCase {

    private static Logger logger = Logger.getLogger(TestCasesWithSuffixTree.class.getName());
    ...
    static {
        ...
        bookStore = BookStoreSuffTreeImpl.getInstance();
        try {
    ...
    public TestCasesWithSuffixTree(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(TestCasesWithSuffixTree.class);
    }
