 ...
 */
public class TestCasesWithBM extends TestCase {

    private static Logger logger = Logger.getLogger(TestCasesWithBM.class.getName());
    ...
    static {
        ...
        bookStore = BookStoreBMImpl.getInstance();
        try {
    ...
    public TestCasesWithBM(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(TestCasesWithBM.class);
    }
